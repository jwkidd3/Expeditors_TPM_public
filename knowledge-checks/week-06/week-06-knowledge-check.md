...
**1. (MC)** In the Power × Interest grid, which quadrant is called the "dangerous" or "surprise-veto" quadrant?
...
**3. False** — Org chart ≠ stakeholder map. Walk the five circles; complete lists run 10–18 names, and the usual omissions (compliance, finance) are exactly who blindside you.
...
**7. B** — Re-frame it in the stakeholder's currency. "Use simpler words" misses the point — CFO → cost, Customer Success → customer outcome, Compliance → regulatory exposure, Eng Director → velocity.
