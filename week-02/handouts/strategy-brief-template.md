...
> **Day 4 · keeper-artifact handout.** The 2–3 page brief that integrates everything from Week 1 forward. Hand-written sections carry the judgment; AI-assembled sections carry the evidence. The provenance log is mandatory — a strategy brief without it is fiction.
...
## What "good" looks like for the pain themes
...
> The **Provenance log** is where trust is built. If it has no "where AI was wrong" entry, you didn't validate — revisit at least one theme.
