# Day 2 — Defining the North Star Metric · Facilitator Guide
> Companion to `labs/day-02-north-star.md`. Facilitator-only — do not hand to participants. Cues, answer keys, timings, reflections.
...
**Answer key / watch-for:** In the 8-card example pack, "Songs Saved to Library" (card 4) is the intended trap — reads clean but is gameable/vanity-prone. "Annual Recurring Revenue" (card 6) is the intended all-three-pitfalls card. Don't reveal these; steer triads to reason their way there.
