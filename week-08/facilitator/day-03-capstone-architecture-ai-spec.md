# Day 3 — Capstone Architecture + AI Spec Drafted · Facilitator Guide

> Companion to `labs/day-03-capstone-architecture-ai-spec.md`. Facilitator-only — do not hand to participants.
