# Day 4 — Technical Logic Validation & Finalization · Facilitator Guide

> Companion to `labs/day-04-validation-finalization.md`. Facilitator-only — do not hand to participants.
