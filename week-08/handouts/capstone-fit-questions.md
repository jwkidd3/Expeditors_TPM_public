...
1. **Re-read your declared candidate** (from end of Week 7). What did you commit to?
2. **Walk the 5 questions** honestly as a triad.
3. **Adjust or commit.** If 1+ question is "no," refine the subject or switch to a backup.
4. **List the inputs you'll need** before tomorrow's discovery — customer interviews, data, docs, system access.
