...
| Dimension | Weight | Exemplary (4) | Score (0–4) |
|-----------|--------|---------------|:-----------:|
...
**Weighted total (out of 4.0):** ____________

---

**Scoring discipline:** score *while listening*, not afterward — memory degrades. Keep a specific note per dimension. Whole-number scores only; no half-points.
