...
1. **One-sentence problem?** Can you state the Holocron problem you are solving in one sentence an engineer could scope from — not a restatement of the mandate, and not a feature list?
2. **Who is it for first?** Have you named the primary user for release one, and can you defend choosing them over the others in the brief?
3. **Substantive but bounded?** Is the slice rich enough to carry a real specification, yet small enough to fully specify in four days?
4. **Evidence, not invention?** For every claim you plan to make, can you point to a fact in the brief — or flag it honestly as an assumption with an owner?
5. **Shippable in 4 days?** Can you produce the full artifact set (PRD-light → TCD-light + TMD-light → AI Spec → SEP-light + DP-light) by Friday morning?
...
### Output
A one-sentence problem statement, a named primary user, an explicit in/out scope line for release one, and a list of discovery inputs to gather before Day 2.
