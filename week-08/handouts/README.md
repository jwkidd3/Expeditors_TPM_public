...
> **Capstone note:** the Week-8 capstone lets triads use their **own** product idea or **FieldPulse**. The templates are subject-agnostic; the FieldPulse artifact set is the practice input on Day 1.
