...
- If observability NFRs don't reference the Tier Sheet signals, the quad is observability-theater; redirect.

## Activity 3 — Security + Accessibility + Compliance

**Cues:**
- "Security: the system shall be secure" gets a hard "no" — push for specifics.
- If a quad has no compliance NFR — ask: "If a regulator audited this feature, what would they ask?" That answer is the NFR.
- A11y is the most-skipped. If a quad omits it, redirect to Week 2 Day 3 work.

## Activity 4 — NFR Cross-Review + Trade-Off Discussion

**Cues:**
- Quads who claim "no trade-offs" haven't read their own NFRs hard enough; surface one for them.
...
- Which quad's defenses were strongest? Hold up Friday as positive example.
- Which quad has the most boilerplate? Coach privately tomorrow morning.
