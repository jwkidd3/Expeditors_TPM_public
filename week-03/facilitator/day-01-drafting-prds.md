# Day 1 — Drafting Technical PRDs from Customer Requirements · Facilitator Guide

> Companion to `labs/day-01-drafting-prds.md`. Facilitator-only — do not hand to participants.
