# Week 3 — Requirements Engineering & Mini-Capstone · Facilitator Overview
...
- `day-01-drafting-prds.md`
- `day-02-acceptance-criteria.md`
- `day-03-nfrs.md`
- `day-04-prd-mini-capstone.md`
- `day-05-prd-review.md`
