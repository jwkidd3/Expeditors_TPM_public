# §5 Solution Sketch — Inclusion / Exclusion Checklist

> **Day 1 · Activity 4 handout.** §5 is the most-mis-written PRD section. Describe the solution *just enough* for an engineer to imagine its shape — not so much that you've designed it for them. Use this checklist while drafting, then run the "engineer's first three questions" test.
...
After writing §5, each triad member proposes the **first three questions** an engineer would ask after reading it. Then diagnose:

| If the questions are about… | Your §5 is… | Do this |
|-----------------------------|-------------|---------|
