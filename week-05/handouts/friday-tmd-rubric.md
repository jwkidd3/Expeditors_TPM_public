...
> **Day 5 handout.** The six dimensions your TMD is scored on in Friday's cross-review — with weights and what "exemplary" looks like in each. Use it as the floor when you self-review, and as the scoring sheet when you review another quad.
...
2. **Pool issues** — de-dupe as a quad.
3. **Cross-review** — pair with another quad; the reviewer scores each dimension against the "exemplary" column.
4. **Adopt / defer / reject** the findings.
5. **Sign-off** — status is either **"Approved"** or **"Approved with gaps."**

## The honesty check

"Approved" without an honest gap list inflates confidence. Treat the rubric as the **floor**, not the ceiling — and name your gaps.
