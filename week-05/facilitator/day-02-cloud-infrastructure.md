...
- If a quad picks self-managed for everything, they're carrying a heavy ops bill. Surface it.
...
- Egress costs are the surprise that hides; coach quads to name outbound bandwidth as a line item.

## End-of-day reflection prompts

- Which quad's ROM cost was most realistic? Hold up Friday.
- Did anyone pick multi-region active-active without justification? Most rookie expensive choice.
- Did any quad pick self-managed for components that have clear managed equivalents? Coach toward defaults.
