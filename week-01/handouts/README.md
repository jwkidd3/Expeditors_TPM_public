# Week 1 Handouts — Customer-Centric Foundations

Participant-facing handouts for Week 1, built on the running case study (**FieldPulse**). Distribute (print or share) before the day and activity that uses it. Templates and cards are meant to be filled in; the facilitator answer keys stay in the lab files, not here.

## Ambient context (given Day 1, referenced all week)

The "ambient context" the Day 1 activity packet promises — evidence, not conclusions.
...
| `analytics-export` | Day 3, Day 4 | Section time-in-app + the end-of-day reconcile funnel (65% step-4 abandonment) |

## Activity handouts

| Handout | Day · Activity | What it is |
|---|---|---|
| `working-backwards-vignettes` | Day 2 · A1 | Four vignettes to judge forward- vs backward-built — no answer key |
| `sample-personas` | Day 3 · A1 | Three personas (Diana / Rita / Tom) to triage — spoiler-free |
| `persona-validation-canvas` | Day 3 · A2 | Blank 6-box persona canvas with evidence-tier columns + 3 validation circles |
| `ride-along-field-note` | Day 3 · A2 | Maria's Tuesday shift — timestamped observed behaviors |
| `dispatcher-character-cards` | Day 3 · A3 | Maria / Trey / Susana role-play cards (Public surface + interviewee-only Hidden) |
