# Week 1 — Customer-Centric Foundations · Facilitator Overview
...
- [ ] Form cohort quads by the end of Day 1 morning; quads persist through Week 3.
...
- [ ] Review the Week 1 capstone readout rubric (in `labs/README.md`).

## Per-day facilitator guides

- `day-01-ai-fundamentals.md`
- `day-02-working-backwards.md`
- `day-03-personas.md`
- `day-04-pain-points.md`
- `day-05-problem-framing.md`
