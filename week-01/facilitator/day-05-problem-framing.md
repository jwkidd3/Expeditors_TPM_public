# Day 5 — Data-Driven Problem Framing · Facilitator Guide

> Companion to `labs/day-05-problem-framing.md`. Facilitator-only — do not hand to participants. Cues, answer keys, timings, reflections.
