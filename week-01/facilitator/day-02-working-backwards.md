# Day 2 — Working Backwards · Facilitator Guide

> Companion to `labs/day-02-working-backwards.md`. Facilitator-only — do not hand to participants. Cues, answer keys, timings, reflections.

## Activity 1 — Forward or Backward?

**Answer key (vignette verdicts):**
- **Vignette A** — Forward — tool-first. (Built the iOS rewrite before checking what techs actually used; missed the Android switch.)
- **Vignette B** — Backward — validated PR. (Mock press release circulated for reaction; re-scoped to the real blocker, login.)
- **Vignette C** — Backward by accident — or forward but lucky? Force the debate. The satisfaction bump doesn't tell you whether the outcome was designed for.
- **Vignette D** — Forward disguised as backward — the PR was fiction, not grounded fiction. AI-generated quotes with no persona research.
